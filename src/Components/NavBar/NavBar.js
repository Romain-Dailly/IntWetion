...
import "./NavBar.css";
import { Layout, Menu, Breadcrumb, Icon, Drawer, Avatar, Button } from "antd";
  ...
  return (
    <div className="account-header">
      ...
      <div className="d-flex">
        <button className="button button-primary mr-3 flex-grow-1" >View profile</button>
    ...
    <header className="main-header background-white">
      <div className="nav-bar">
        <Link to="/" className="logo mr-3">
          ...
          <p style={{ color: "var(--dark)" }} className="m-0 ">Intwetion</p>
        </Link>
        <i
